...
void GameScene3::Update(float dTime) {
	Scene::Update(dTime);
	UISetting();
	TimerSetting(dTime);
	OptimizationObject();
...
void GameScene3::TimerSetting(float dTime) {
	/*coinInstDelayTimer += dTime;*/
	/*obstacleInstDelayTimer += dTime;*/
}

void GameScene3::UISetting() {
...
void GameScene3::OptimizationObject() {
...
void GameScene3::CollisionCheck() {
	/*for (auto iter = coinList.begin(); iter != coinList.end(); iter++) {
...
void GameScene3::EnemyCheck(float dTime) {
...
void GameScene3::InstantiateObject() {
