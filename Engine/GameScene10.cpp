...
void GameScene10::Update(float dTime) {
	Scene::Update(dTime);
	UISetting();
	TimerSetting(dTime);
	OptimizationObject();
...
void GameScene10::TimerSetting(float dTime) {
	/*coinInstDelayTimer += dTime;*/
	/*obstacleInstDelayTimer += dTime;*/
}

void GameScene10::UISetting() {
...
void GameScene10::OptimizationObject() {
...
void GameScene10::CollisionCheck() {
	/*for (auto iter = coinList.begin(); iter != coinList.end(); iter++) {
	...
	else if (player->IsCollisionRect((water1)) && !(water1->getColor() == 5) && !isBox) {
		player->changeColor(water1->getColor());
	}
	...
	if (player->IsCollisionRect((enemy)) && !(player->getColor() == enemy->getColor()) && !isBox && enemy->getWater()&&!(player->getColor()==3)) {
		sceneManager->ChangeScene(new GameScene10());
		return;
	}
	else if (player->IsCollisionRect((enemy)) && !(player->getColor() == enemy->getColor()) && !isBox && enemy->getWater() && player->getColor() == 3) {
		enemy->changeWater(false);
	}
	if (player->IsCollisionRect((enemy1)) && !(player->getColor() == enemy1->getColor()) && !isBox && enemy1->getWater() && !(player->getColor() == 3)) {
		sceneManager->ChangeScene(new GameScene10());
		return;
	}
	else if (player->IsCollisionRect((enemy1)) && !(player->getColor() == enemy1->getColor()) && !isBox && enemy1->getWater() && player->getColor() == 3) {
		enemy1->changeWater(false);
	}
	if (player->IsCollisionRect((enemy2)) && !(player->getColor() == enemy2->getColor()) && !isBox && enemy2->getWater() && !(player->getColor() == 3)) {
		sceneManager->ChangeScene(new GameScene10());
		return;
	}
	else if (player->IsCollisionRect((enemy2)) && !(player->getColor() == enemy2->getColor()) && !isBox && enemy2->getWater() && player->getColor() == 3) {
		enemy2->changeWater(false);
	}
	/*for (auto iter = obstacleList.begin(); iter != obstacleList.end(); iter++) {*/
...
void GameScene10::EnemyCheck(float dTime) {
...
void GameScene10::InstantiateObject() {
